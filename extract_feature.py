...
def processFiles(pos_dir, neg_dir, recurse=False, output_file=False,
                 ...
                 hog_features=False, size=(64, 64), hog_bins=9, pix_per_cell=(8, 8),
    ...
    descriptor = Descriptor(hog_features=hog_features, size=size,
...
pos_dir = "data/BU101/images/Biking"
neg_dir = "data/stanford40"
processFiles(pos_dir, neg_dir, recurse=False, output_file=False,
             output_filename=None, color_space="bgr", channels=[0, 1, 2],
             hog_features=True, size=(64, 64), hog_bins=9, pix_per_cell=(8, 8),
             cells_per_block=(2, 2), block_stride=None, block_norm="L1",
             transform_sqrt=True, signed_gradient=False)
